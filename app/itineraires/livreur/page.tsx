            ...
            >
                ...
                */
                ...
                <p className="text-base flex items-center">
                    - <b className="text-lg"> itinéraire 1</b> : livreur1.nom
                    <span className="ml-auto">
                        {/* eslint-disable-next-line jsx-a11y/alt-text */}
                        <Image width={30} src="/flecheSuivant.png" preview={false}
                ...
                <p>---------------------------------</p>
                <p className="text-base flex items-center">
                    - <b className="text-lg"> itinéraire 2</b> : livreur2.nom
                    <span className="ml-auto">
                        {/* eslint-disable-next-line jsx-a11y/alt-text */}
                        <Image width={30} src="/flecheSuivant.png" preview={false}
                               className='hover:bg-orange-600 rounded-full'/>
                ...
                <p>---------------------------------</p>
                <p className="text-base flex items-center">
                    - <b className="text-lg"> itinéraire 3</b> : livreur3.nom
                    <span className="ml-auto">
                        {/* eslint-disable-next-line jsx-a11y/alt-text */}
                        <Image width={30} src="/flecheSuivant.png" preview={false}
                               className='hover:bg-orange-600 rounded-full'/>
